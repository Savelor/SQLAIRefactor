...
Many devs wrongly assume stored procedures prevent SQL injection. The following example illustrates code that may be vulnerable to a SQL injection attack:
